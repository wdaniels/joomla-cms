...
(
  ...
  "created_date" DATETIME DEFAULT '0001-01-01 00:00:00',
  "modified_date" DATETIME DEFAULT '0001-01-01 00:00:00',
  PRIMARY KEY ("id")
);
...
(
  ...
  "checked_out_time" DATETIME DEFAULT '0001-01-01 00:00:00',
  ...
  "modified" DATETIME DEFAULT '0001-01-01 00:00:00',
  ...
  "publish_up" DATETIME DEFAULT '0001-01-01 00:00:00',
  "publish_down" DATETIME DEFAULT '0001-01-01 00:00:00',
  PRIMARY KEY ("id")
);
...
(
  ...
  "date_time" DATETIME DEFAULT '0001-01-01 00:00:00',
...
(
  ...
  "manifest_cache" LONG NVARCHAR NOT NULL,
  "params" LONG VARBINARY NOT NULL,
  "custom_data" LONG NVARCHAR NOT NULL,
  "system_data" LONG NVARCHAR NOT NULL,
  "checked_out" BIGINT DEFAULT 0,
  "checked_out_time" DATETIME DEFAULT '0001-01-01 00:00:00',
  "ordering" INTEGER DEFAULT 0,
...
(
  ...
  "indexdate" DATETIME DEFAULT '0001-01-01 00:00:00',
  "md5sum" NVARCHAR DEFAULT NULL,
  "published" SMALLINT DEFAULT 1,
  "state" INTEGER DEFAULT 1,
  "access" INTEGER DEFAULT 0,
  "language" NVARCHAR DEFAULT N'',
  "publish_start_date" DATETIME DEFAULT '0001-01-01 00:00:00',
  "publish_end_date" DATETIME DEFAULT '0001-01-01 00:00:00',
  "start_date" DATETIME DEFAULT '0001-01-01 00:00:00',
  "end_date" DATETIME DEFAULT '0001-01-01 00:00:00',
...
(
  ...
  "created_time" DATETIME DEFAULT '0001-01-01 00:00:00',
  "modified_user_id" BIGINT DEFAULT 0,
  "modified_time" DATETIME DEFAULT '0001-01-01 00:00:00',
  "hits" BIGINT DEFAULT 0,
  "language" NVARCHAR DEFAULT N'',
  PRIMARY KEY ("id")
);
...
(
  ...
  "publish_up" DATETIME DEFAULT '0001-01-01 00:00:00',
  "publish_down" DATETIME DEFAULT '0001-01-01 00:00:00',
  "reset" DATETIME DEFAULT '0001-01-01 00:00:00',
  "created" DATETIME DEFAULT '0001-01-01 00:00:00',
  "language" NVARCHAR DEFAULT N'',
  PRIMARY KEY ("id")
);
...
(
  "track_date" DATETIME DEFAULT '0001-01-01 00:00:00',
...
(
  ...
  "modified_user_id" BIGINT DEFAULT 0,
  "modified_time" DATETIME DEFAULT '0001-01-01 00:00:00',
  "review_time" DATETIME DEFAULT '0001-01-01 00:00:00',
  "publish_up" DATETIME DEFAULT '0001-01-01 00:00:00',
  "publish_down" DATETIME DEFAULT '0001-01-01 00:00:00',
  PRIMARY KEY ("id")
);
...
(
  ...
  "registerDate" DATETIME DEFAULT '0001-01-01 00:00:00',
  "lastvisitDate" DATETIME DEFAULT '0001-01-01 00:00:00',
...
(
  ...
  "url" NVARCHAR DEFAULT N'',
  "description" NVARCHAR DEFAULT N'',
  "date" DATETIME DEFAULT '0001-01-01 00:00:00',
